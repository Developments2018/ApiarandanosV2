...
class WorkOrderController extends Controller
{
    ...
    {   
        $work_orders = WorkOrder::paginate(22);
        return view('admin.work_orders.index')->with(compact('work_orders'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.work_orders.create')->with(compact('work_orders'));
    }
